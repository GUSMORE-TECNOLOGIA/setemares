...
export function StatusMessage({
  ...
  }, [autoHide, autoHideDelay, isVisible, onClose]);
  ...
  return (
    ...
    >
      ...
      {onClose && (
        <button
          onClick={onClose}
          className="flex-shrink-0 ml-2 p-1 rounded-md hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20"
