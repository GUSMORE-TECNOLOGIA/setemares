...
-- Data: 2025-01-07
-- Objetivo: Execute este script no Supabase Dashboard SQL Editor
-- =====================================================

-- PASSO 1: Limpar todas as tabelas (ordem importante devido às foreign keys)
DELETE FROM quote_segments;
DELETE FROM quotes;
DELETE FROM codes_unknown;
DELETE FROM code_overrides;
DELETE FROM airports;
DELETE FROM cities;
DELETE FROM airlines;

-- PASSO 2: Resetar sequences
