-- =====================================================
-- MIGRAÇÃO FORÇADA: Limpeza completa de companhias aéreas
-- Data: 2025-01-07
-- Objetivo: Forçar limpeza de TODOS os dados inválidos
-- =====================================================
...
-- PASSO 3: FORÇAR limpeza de dados inválidos
-- Limpar TODOS os IATA que não são exatamente 2 caracteres alfanuméricos
UPDATE airlines 
SET iata2 = NULL 
...
-- Limpar TODOS os ICAO que não são exatamente 3 letras
UPDATE airlines 
SET icao3 = NULL 
